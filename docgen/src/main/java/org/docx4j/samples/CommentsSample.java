...
public class CommentsSample extends AbstractSample {
	   ...
	   public static void main(String[] args) throws Exception {
		...
		BigInteger commentId = BigInteger.valueOf(0);
	    ...
	    private static org.docx4j.wml.Comments.Comment createComment(BigInteger commentId,
...
//				comment.setDate(value)
	    ...
	    private static org.docx4j.wml.R createRunCommentReference(BigInteger commentId) {
